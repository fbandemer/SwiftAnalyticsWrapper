...
/// Contract for evaluating feature flags independently of analytics tracking.
public protocol FeatureFlagManaging: AnyObject {
    func configure(key: String)
    func isFeatureFlagEnabled(_ key: String) -> Bool
    func featureFlagPayloadIfEnabled(_ key: String) -> AnalyticsFeatureFlagPayload?
    func featureFlagVariant(_ key: String) -> String?
    func isFeatureFlag(_ key: String, inVariant variant: String) -> Bool
    func featureFlagPayload(_ key: String, matching variant: String) -> AnalyticsFeatureFlagPayload?
}
